...
public abstract class MixinLostCityTerrainFeatureThreadSafeRandoms {
    ...
    /**
     * This offers a thread-safe replacement for Lost Cities' static Random used in offsets. It maintains the same outcomes as the original while preventing problems from shared state during parallel generation.
     *
     * @author Admany
    ...
    /**
     * This provides a thread-safe option instead of Lost Cities' static Random for offsets.
     *
     * @author Admany
     * @reason Prevent nondeterminism and corruption under parallel worldgen
     */
    ...
    /**
     * This introduces a thread-safe alternative to Lost Cities' static Random for vegetation placement.
     *
     * @author Admany
