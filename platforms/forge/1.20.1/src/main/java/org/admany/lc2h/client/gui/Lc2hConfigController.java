...
final class Lc2hConfigController {
    ...
    private static boolean requiresRestartForChanges(ConfigManager.Config before, ConfigManager.Config after) {
        ...
        if (Double.compare(before.treeSeamRadiusMultiplier, after.treeSeamRadiusMultiplier) != 0) return true;
    ...
    private void applyFormValuesToState(UiState target, FormValues values) {
        ...
        tryParseDouble(values.treeSeamRadiusMultiplier(), v -> target.treeSeamRadiusMultiplier = clampDoubleRange(v, 0.5D, 3.0D));
    ...
    private UiState copyState(UiState src) {
        ...
        copy.enableLc2hLogging = src.enableLc2hLogging;
        ...
        copy.treeSeamRadiusMultiplier = src.treeSeamRadiusMultiplier;
    ...
    private double clampDoubleRange(double value, double min, double max) {
        return Math.max(min, Math.min(max, value));
    }
    ...
    private ConfigManager.Config copyConfig(ConfigManager.Config src) {
        ...
        c.enableLc2hLogging = src.enableLc2hLogging;
        ...
        c.treeSeamRadiusMultiplier = src.treeSeamRadiusMultiplier;
    ...
    private UiState toState(ConfigManager.Config config) {
        ...
        if (config == null) {
            ...
            state.treeSeamRadiusMultiplier = clampDoubleRange(ConfigManager.TREE_SEAM_RADIUS_MULTIPLIER, 0.5D, 3.0D);
        ...
        state.enableLc2hLogging = config.enableLc2hLogging;
        ...
        state.treeSeamRadiusMultiplier = clampDoubleRange(config.treeSeamRadiusMultiplier, 0.5D, 3.0D);
    ...
    private ConfigManager.Config toConfig(UiState state, ConfigManager.Config base) {
        ...
        config.enableLc2hLogging = state.enableLc2hLogging;
        ...
        config.treeSeamRadiusMultiplier = (float) clampDoubleRange(state.treeSeamRadiusMultiplier, 0.5D, 3.0D);
    ...
    private boolean configsEqual(ConfigManager.Config a, ConfigManager.Config b) {
        ...
        return a.enableAsyncDoubleBlockBatcher == b.enableAsyncDoubleBlockBatcher
            ...
            && a.enableLc2hLogging == b.enableLc2hLogging
            ...
            && Double.compare(a.treeSeamRadiusMultiplier, b.treeSeamRadiusMultiplier) == 0
    ...
    record FormValues(
        ...
        String treeSeamRadiusMultiplier,
    ...
    static final class UiState {
        ...
        public boolean enableLc2hLogging;
        ...
        public double treeSeamRadiusMultiplier;
